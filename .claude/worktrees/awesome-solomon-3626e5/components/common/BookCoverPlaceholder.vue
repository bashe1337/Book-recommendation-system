<template>
	<!--
		...
		Использовать готовую npm-библиотеку специально для книжных обложек смысла
		не было: либо они переусложнены (тащат canvas/wasm), либо устарели.
		Чистый SVG с двумя шаблонами легче и точно даёт нужный стиль скриншотов.
	-->
	<svg
		:width="width"
		:height="height"
